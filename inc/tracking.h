...
#define BASIC_ROTATE_ANGLE 4500 // 基础旋转角度，相对角度旋转函数旋转的角度将此值乘以系数计算移动
#define BASIC_ROTATE_SPEED 25   // 基础旋转速度，相对角度旋转函数旋转的速度将此值乘以系数计算移动
...
#define STOP_THRESHOLD 0.01     // 偏移量均小于该值时停止转动并认为已经完成追踪
